...
class Mbsa_Plugin_Template {

	/**
	 * The single instance of Mbsa_Plugin_Template.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	/**
	 * Main Mbsa_Plugin_Template Instance
	 *
	 * Ensures only one instance of Mbsa_Plugin_Template is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Mbsa_Plugin_Template()
	 * @return Main Mbsa_Plugin_Template instance
	 */
